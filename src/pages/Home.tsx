        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-12 mb-16">
            <div className="col-span-2">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                The most comprehensive test series platform for competitive exam preparation, trusted by thousands of students.
              </p>
            ...
            <div>
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Test Series</h3>
              <ul className="space-y-3">
                {['Quantitative Aptitude', 'Logical Reasoning', 'Verbal Ability', 'Full Mocks'].map((item) => (
                  <li key={item}>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Blog', 'Practice Tips', 'Formula Sheets', 'Webinars'].map((item) => (
                  <li key={item}>
                    <Link to={`/${item.toLowerCase().replace(' ', '-')}`} className="text-gray-400 hover:text-white transition-colors">
                      {item}
                    </Link>
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} AptiPro Test Series. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
